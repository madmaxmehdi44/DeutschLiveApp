...
import 'package:deutschliveapp/widgets/home%20pages%20widgets/mainappbar.dart';
import 'package:deutschliveapp/widgets/home%20pages%20widgets/topnavbar.dart';
...
class _FavoritesPageState extends State<FavoritesPage> {
  ...
  void _favoriteChange(int index) async {
    List<Channel> favoritedChannels = storageProvider.storage
        .get('favoritedChannelList' as List, defaultValue: []).cast<Channel>();
            ...
            body: Column(
              children: [
                ...
                const Expanded(
                  child: Center(
                    child:
                        Text('لیست خالیست', style: TextStyle(fontSize: 14.0)),
                  ),
                ),
              ],
            ),
